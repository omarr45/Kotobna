...
library.books.push(new Book("The Mothers", "Brit Bennett", "Novels", "assets/covers/tm.jpeg", "https://www.goodreads.com/book/show/28815371-the-mothers?from_search=true&from_srp=true&qid=BRzGo06tQe&rank=1", ""));
...
library.books.push(new Book("Brief Answers To Big Questions", "Stephen Hawking", "Science", "assets/covers/babq.jpg", "https://www.goodreads.com/book/show/40277241-brief-answers-to-the-big-questions?from_search=true&from_srp=true&qid=diPOSkheV8&rank=1", ""));
...
library.books.push(new Book("Cosmos", "Carl Sagan", "Science", "assets/covers/c.jpg", "https://www.goodreads.com/book/show/55030.Cosmos?from_search=true&from_srp=true&qid=IZxM6jmujO&rank=1", ""));
...
library.books.push(new Book("Concepts of Modern Mathematics", "Ian Stewart", "Science", "assets/covers/comm.jpg", "https://www.goodreads.com/book/show/183761.Concepts_of_Modern_Mathematics?from_search=true&from_srp=true&qid=I3kFPxsy5w&rank=1", ""));
...
library.books.push(new Book("Black Holes And Baby Universes", "Stephen Hawking", "Science", "assets/covers/bhabu.jpg", "https://www.goodreads.com/book/show/53200.Black_Holes_and_Baby_Universes_and_Other_Essays?from_search=true&from_srp=true&qid=QXorNG0GwU&rank=1", ""));
library.books.push(new Book("Still Me", "Jojo Moyes", "Novels", "assets/covers/sm.jpg", "https://www.goodreads.com/book/show/41839602-still-me?from_search=true&from_srp=true&qid=n2hDb6L0r5&rank=1", ""));
